...
from sqlalchemy import (
    DateTime, ForeignKey, String, Text, Integer, Enum, Identity
)
...
class SDCForm(Base):
    ...
    sdc_questions = relationship(
        "SDCQuestion", back_populates="sdc_form", cascade="all, delete-orphan"
    )
...
class SDCQuestion(Base):
    ...
    sdc_form_id: Mapped[int] = mapped_column(
        ForeignKey("sdc_forms.id"), nullable=False, index=True
    )
